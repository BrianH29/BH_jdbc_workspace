...
public class Member {
	...
	private Date enrollDate; 		// --> DB와 연동할경우 java.sql import 해야 됨!!

	
	//constructor
	public Member() {}
	
	// 매개변수 생성자 ( **회원가입시 사용자가 입력한 값들만 전달되서 초기화 해주는 생성자)
	...
	//parameter 매개변수생성자 (모든 필드값 받아서 초기화 하는 생성자) 
	...
	public String toString() {
		return userNo + ", " + userId + ", " + userPwd + ", " + userName + ", " + gender + ", " + age + ", " + email + ", " 
